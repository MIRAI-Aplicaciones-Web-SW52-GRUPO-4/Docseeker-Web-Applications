...
export const useCounterStore = defineStore('counter', () => {
  ...
  const reviews = ref([
    ...
    },
    {
      ...
      customerReview: "SWiwiwiiwiery kind at all times and help me understand how I should correctly perform my daily routine to take care of myself.",
      customerScore: 2,
      idPatient: 1,
      idDoctor: 0
    },
    {
      ...
      profilePhotoUrl: "../../src/assets/images/Alessandro Ramirez image.jpg",
      customerName: "Alessandro Ramirez",
      customerReview: "PROBANDOry kind at all times and help me understand how I should correctly perform my daily routine to take care of myself.",
      customerScore: 3,
      idPatient: 1,
      idDoctor: 1
    },
    {
      ...
      customerReview: "OLIWIWIWIWI at all times and help me understand how I should correctly perform my daily routine to take care of myself.",
      customerScore: 2,
      idPatient: 1,
      idDoctor: 2
    }
  ...
  return { news, patients, doctors, medicalInformation, prescriptions, dates, reviews, doubleCount, newViewed }
})
